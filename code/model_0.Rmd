...
df <- read.csv("/Users/ashiqmuhammad04/Desktop/epistemic_analytics/mamta_elsevier/datasets/data_org_and_encoded.csv")
...
```{r}
#unit_cols <- c("Patient.Student.Pair", "Participant", "cases")
# unit_cols <- c("Patient.Student.Pair", "Participant", "cases", "SH.Feature")
### Muhammad: Try different unit cols
# Model 1: unit_cols <- c("Patient.Student.Pair", "Participant")
# Model 2: 
unit_cols <- c("Patient.Student.Pair", "Participant", "cases")
# Model 3: unit_cols <- c("Patient.Student.Pair", "Participant", "SH.Feature")
# Model 4: unit_cols  <- c("Patient.Student.Pair", "Participant", "SH.Feature", "cases")
# Model 5: unit_cols <- c("Patient.Student.Pair", "Participant", "SH.Feature", "Modality")
# Model 6: unit_cols <- c("Patient.Student.Pair", "Participant", "SH.Feature", "Modality", "cases")
...
source("/Users/ashiqmuhammad04/Desktop/epistemic_analytics/mamta_elsevier/code/ona_plotter.R") # Change this back after
